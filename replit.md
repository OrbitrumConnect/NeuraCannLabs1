...
- **Scanner System**: Horizontal line scanner with synchronized avatar glow effect. Yellow line appears during 22%-32% of screen scan (1 second duration). Dr. Cannabis avatar glows yellow 2 seconds earlier (10%-32%) to anticipate the line. Soft yellow color (rgba(255,235,59)) with 30% reduced intensity for elegant effect.
