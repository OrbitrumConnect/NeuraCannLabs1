    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-8 gap-4 mb-8">
          <Card className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 border-blue-500/20 col-span-2">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">{globalStats.globalStudies.toLocaleString()}</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as any)} className="w-full">
          ...
          <TabsContent value="global-data" className="mt-6">
