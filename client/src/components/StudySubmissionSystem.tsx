  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center mb-8">
        <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-lime-400 rounded-xl flex items-center justify-center mr-4">
          <i className="fas fa-brain text-white text-2xl" />
        </div>
        <div>
          <h1 className="text-3xl font-bold text-white">Sistema de Submissão de Estudos</h1>
          <p className="text-gray-400">Crie, edite e submeta estudos científicos para análise profissional</p>
        </div>
      </div>
